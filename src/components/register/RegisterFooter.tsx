            ...
            <div className="flex flex-col gap-3">
              <a href="#" className="inline-flex items-center gap-2 bg-white rounded-lg px-4 py-2.5 hover:bg-gray-100 transition-colors">
                <svg viewBox="0 0 24 24" className="w-5 h-5">
                  <path
                    fill="#EA4335"
                    d="M3.18 1.01a2.05 2.05 0 0 0-.48 1.42v19.14c0 .51.17.99.48 1.42l.08.07 10.72-10.72v-.25L3.26.94l-.08.07z"
                  />
                  <path
                    fill="#FBBC04"
                    d="M17.55 15.9l-3.57-3.58v-.25l3.57-3.57.08.04 4.23 2.4c1.21.69 1.21 1.81 0 2.5l-4.23 2.4-.08.06z"
                  />
                  <path fill="#34A853" d="M17.63 15.85L13.98 12 3.18 22.99c.4.42.99.45 1.67.06l12.78-7.2" />
                  <path
                    fill="#4285F4"
                    d="M17.63 8.15L4.85 1.01c-.68-.39-1.27-.36-1.67.06L13.98 12l3.65-3.85z"
                  />
                </svg>
