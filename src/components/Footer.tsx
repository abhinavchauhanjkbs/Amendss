...
import ctaPartner from "@/assets/cta-partner.png";
...
const Footer = ({ ctaImage, ctaAlt }: FooterProps) => {
  const bannerImage = ctaImage ?? ctaPartner;
  const bannerAlt = ctaAlt ?? "Partner with us CTA";
  const quickLinks = [
    { label: "Home", href: "/" },
